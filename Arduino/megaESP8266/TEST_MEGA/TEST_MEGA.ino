...
#define FIRST_PIN 0   // First PIN of the board
#define LAST_PIN 53   // Last PIN of the board
#define PIN_LED  13   // The PIN which connceted with LED
  ...
  if (Serial.available() > 0) {
    switch (Serial.read()) {
      ...
      case 'b':
        ...
        displayHelp();
      break;
      case 'c': // Check the proper working of all output PINS from the first till last PINOUT
